      ...
      <section className="section section-lg" ref={ref}>
        <Container>
          <div className="d-flex flex-column align-items-center justify-content-center mb-5 text-center">
            ...
            >
              Testimonials <span className="gradient-text">& Value</span>
            </motion.h1>
            ...
            >
              Feedback from collaborators and clients I've had the pleasure to work with.
            </motion.p>
          </div>

          <Row className="row-grid align-items-stretch justify-content-center">
            {feedbacks.map((data, i) => (
              <Col key={i} lg={6} className="mb-4">
                <FeedbackCard {...data} index={i} />
              </Col>
            ))}
          </Row>
        </Container>
